  ...
  !(function(e) {
    ...
    e.overlayMode = function(o, r, a) {
      return {
        ...
        token: function(e, n) {
          return (e != n.streamSeen ||
            Math.min(n.basePos, n.overlayPos) < e.start) &&
            (
              (n.streamSeen = e),
              (n.basePos = n.overlayPos = e.start)
            ), e.start == n.basePos &&
            ((n.baseCur = o.token(e, n.base)), (n.basePos = e.pos)), e.start ==
            n.overlayPos &&
            (
              (e.pos = e.start),
              (n.overlayCur = r.token(e, n.overlay)),
              (n.overlayPos = e.pos)
            ), (e.pos = Math.min(n.basePos, n.overlayPos)), null == n.overlayCur
            ? n.baseCur
            : (null != n.baseCur && n.overlay.combineTokens) ||
              (a && null == n.overlay.combineTokens)
        ...
        blankLine: function(e) {
          o.blankLine && o.blankLine(e.base), r.blankLine &&
            r.blankLine(e.overlay)
        },
      }
    }
  })
