  ...
  <div class="ui container settings-content">
    ...
    <form id="mainForm" class="ui form">
      <div class="ui secondary pointing menu">
        ...
        <div class="item" v-for="tab in tabs" :key="tab.id" :data-tab="tab.id">{{ tab.label }}</div>
      </div>
      ...
      <div class="ui bottom attached tab segment " v-for="tab in tabs" :key="tab.id" :data-tab="tab.id">
