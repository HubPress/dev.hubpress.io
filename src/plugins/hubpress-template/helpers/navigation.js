...
navigation = function(options) {
  ...
  if (!_.isObject(navigationData) || _.isFunction(navigationData)) {
    return logAndThrowError('warnings.helpers.navigation.invalidData')
  }
  ...
  if (
    ...
    return logAndThrowError('warnings.helpers.navigation.valuesMustBeDefined')
  }
  ...
  if (
    ...
    return logAndThrowError('warnings.helpers.navigation.valuesMustBeString')
  }
