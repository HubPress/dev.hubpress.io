 ...
 */
ConfigManager.prototype.set = function(context) {
  var localPath = '',
    config,
    theme,
  ...
  //     }
  // }
  this._config.url = config.urls && config.urls.site
  ...
  _.merge(this._config, {
    ...
    activeTheme: {
      ...
      name: config.theme && config.theme.name,
    },
    theme: {
  ...
  console.log('ConfigManager ==================', this)
}
