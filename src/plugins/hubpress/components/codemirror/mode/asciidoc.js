        ...
        var HighlightRules = function () {
            ...
            this.$rules = {
                ...
                "paragraphEnd": [
                    ...
                    {token: "singleLineTitle", regex: /^={1}\s+\S.*$/, next: "start"},
                    {token: "singleLineTitle2", regex: /^={2}\s+\S.*$/, next: "start"},
                    {token: "singleLineTitle3", regex: /^={3}\s+\S.*$/, next: "start"},
                    {token: "singleLineTitle4", regex: /^={4}\s+\S.*$/, next: "start"},
                    {token: "singleLineTitle5", regex: /^={5}\s+\S.*$/, next: "start"},
                    {token: "singleLineTitle6", regex: /^={6}\s+\S.*$/, next: "start"},
