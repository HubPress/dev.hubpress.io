  ...
  return fires.fireRequestLocalPost(opts)
        ...
        .then(updatedOpts => {
          if (updatedOpts.nextState.post && updatedOpts.nextState.post.title) {
            return fires.fireRequestSaveLocalPost(updatedOpts)
...
function publishPost(opts) {
  return fires.fireRequestLocalPost(opts)
        ...
        .then(updatedOpts => {
          ...
          const oTags = (updatedOpts.nextState.post.original && updatedOpts.nextState.post.original.tags) || [];
        ...
        .then(updatedOpts => fires.fireRequestSaveRemotePublishedElements(updatedOpts))
        .then(updatedOpts => fires.fireReceiveSaveRemotePublishedElements(updatedOpts))
}
...
function unpublishPost(opts) {
  return fires.fireRequestLocalPost(opts)
        ...
        .then(updatedOpts => fires.fireRequestDeleteRemotePublishedPost(updatedOpts))
        .then(updatedOpts => fires.fireReceiveDeleteRemotePublishedPost(updatedOpts))
        // Maybe we should make something fireRequestMarkAsPublished
        .then(updatedOpts => {
  ...
  return fires.fireRequestLocalPost(opts)
        ...
        .then(updatedOpts => {
          if (updatedOpts.nextState.post.original) {
            return fires.fireRequestDeleteRemotePost(updatedOpts)
        ...
        .then(updatedOpts => {
          if (!updatedOpts.nextState.post.published) {
            ...
            return fires.fireRequestDeleteRemotePublishedPost(updatedOpts)
                  .then(updatedOpts => fires.fireReceiveDeleteRemotePublishedPost(updatedOpts))
                  // Get publishedPosts to rebuild all content
                  .then(updatedOpts => fires.fireRequestLocalPublishedPosts(updatedOpts))
                  .then(updatedOpts => fires.fireReceiveLocalPublishedPosts(updatedOpts))
