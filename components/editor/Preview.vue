<template lang="html">
  <div>
    <div class="html-rendering" v-if="!iframe">
      <h1 class="ui header">{{document.title}}</h1>
      <div id="html-content" class="content" v-html="document.html"></div>
    </div>

    <div class="iframe-rendering" v-if="iframe">
      <iframe class="published-preview" :srcdoc="document.publishedContent" frameborder="0"></iframe>
    </div>
  </div>
</template>
